...
class NavigateCells(Node):
    def __init__(self):
        ...
        self.subs_right_ir = self.create_subscription(Range, 'right_IR', self.rightIR_cb, 1)
        self.subs_left_ir = self.create_subscription(Range, 'left_IR', self.leftIR_cb, 1)
        self.subs_front_ir = self.create_subscription(Range, 'front_IR', self.frontIR_cb, 1)
    ...
    def rightIR_cb(self, msg):
        self.rds = msg.range
        self.get_logger().info("how often in master")
        self.get_logger().info(str(self.rds))
